...
window.Cliente = function (nome) {
  this.name = nome = "Cliente";
  this.clone = function () {
...
export default {
  ...
  methods: {
    ...
    addSidebarIcon: function (graph, sidebar, prototype) {
      ...
      wrapper1.style.backgroundColor = "red";
      ...
      wrapper1.innerHTML =
        '<div style="color: #F8F8FF"><strong>Cliente</strong></div>';
      sidebar.appendChild(wrapper1);
      //Empresa.sidebar.appendChild(wrapper1);
